...
while True:
	...
	xxx = {'customerName':'aswadawqwe123','email': bacot[0],'emailCheck': bacot[0],'password':'Kontol123','passwordCheck':'Kontol123'}
	...
	if "You indicated you are a new customer, but an account already exists with the e-mail" in cek:
		...
		die.write(email)
print("-"*50)
print("\033[35;1mProses Check Selesai (Coded By k0p3t)\033[0m")
